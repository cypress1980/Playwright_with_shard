...
test("Browser Context example", async ({ browser }) => {
  ...
  await firstPage.goto('https://automationexercise.com/login', { waitUntil: 'domcontentloaded' });
  ...
  await thirdPage.goto('https://automationexercise.com/login', { waitUntil: 'domcontentloaded' });
